...
class ESU(EsUserVideo):
    es = Elasticsearch('http://esreader:NzdmMGM4MzE2@10.0.4.101:4000', dead_timeout=10,
            ...
            "query": {
                "bool": {
                    "must": [
                        {
                            "exists": {
                                "field": "star_list_update_time"
                            }
                        },
                        {
                            "range": {
                                "star_list_update_time": {
                                    "gte": "2022-06-20"
                                }
                            }
                        }

...
```ctl
#key没有才设置 有返回空 
setnx key value		(存在0 不存在1)
set key value NX	(存在nil)

set key value XX

set key value EX 1 秒
set key value PX 1000 毫秒

ttl key

mset key value...
getset key value (获取设置返回新值)
...
127.0.0.1:6379[1]> multi
OK
127.0.0.1:6379[1]> incrbyfloat age 13
QUEUED
127.0.0.1:6379[1]> incrbyfloat age 13
QUEUED
		10.0.17.103:6379[1]> incr age
		(integer) 19
		10.0.17.103:6379[1]>
127.0.0.1:6379[1]> exec
(nil)
...
```shell
[root@node0 redis-5.0.8]# cat redis.conf 
